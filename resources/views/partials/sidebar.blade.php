		...
		<ul>
			...
			@section('sidebar-nav-links')
				@if(Auth::user()->admin)
					...
					<li class="ripple-effect"><a href="#"><i class="material-icons md-24 grey700">poll</i>Stats</a></li>
					<li class="ripple-effect"><a href="#"><i class="material-icons md-24 grey700">build</i>Repair Orders</a></li>
					<li class="ripple-effect"><a href="#"><i class="material-icons md-24 grey700">local_shipping</i>Part Orders</a></li>
					<li class="ripple-effect"><a href="#"><i class="material-icons md-24 grey700">assignment</i>Inventory Ordering</a></li>
